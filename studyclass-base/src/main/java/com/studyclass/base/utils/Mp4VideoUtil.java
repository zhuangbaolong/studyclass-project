package com.studyclass.base.utils;
...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "F:\\software\\ffmpeg-2024-10-31-git-87068b9600-full_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "F:\\software\\ffmpeg\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "F:\\M500000xwRab1XU3Es.mp3";
        //转换后mp4文件的名称
        String mp4_name = "ff1.mp4";
        //转换后mp4文件的路径
        String mp4_path = "F:\\ff1.mp4";
        //创建工具类对象
