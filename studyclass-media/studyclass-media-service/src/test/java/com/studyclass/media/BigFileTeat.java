 ...
 * 测试分块大文件上传
 */
public class BigFileTeat {

    //测试文件分块方法
    @Test
    public void testChunk() throws IOException {
        //源文件目录
        File sourceFile = new File("F:\\workspace\\project\\springcloud\\studyclass\\video\\jiexianji.mp4");
        //块文件目录
        String chunkPath = "F:\\workspace\\project\\springcloud\\studyclass\\video\\chunk\\";
        //分块大小
