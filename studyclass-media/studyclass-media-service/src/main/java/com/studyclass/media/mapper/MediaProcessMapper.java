package com.studyclass.media.mapper;
...
public interface MediaProcessMapper extends BaseMapper<MediaProcess> {
    ...
    @Select("Select * from media_process t where t.id % #{shardTotal} = #{shardIndex} and (t.status = '1' or t.status = '3')" +
            "and t.fail_count < #{count} limit #{count}")
